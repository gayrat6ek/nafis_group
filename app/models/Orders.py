...
class Orders(Base):
    ...
    delivery_address = Column(String, nullable=False)  # Full address for delivery
    delivery_phone_number = Column(String, nullable=False)  # Phone number for delivery contact
    delivery_date = Column(DateTime(timezone=True), nullable=False)
    delivery_fee = Column(Float, nullable=False, default=0.0)

    payment_method = Column(String, nullable=False)  # e.g., 'credit_card', 'cash', etc.
